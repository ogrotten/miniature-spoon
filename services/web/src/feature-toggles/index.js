import { featureTogglesStore } from "./stores";
...
const setFeatureTogglesStore = (configValues) => Object.keys(FEATURE_TOGGLES).forEach((toggleKey) => {
    const featureToggleName = FEATURE_TOGGLES[toggleKey].name;
    if (configValues[featureToggleName]) {
        featureTogglesStore.setFeatureToggle(featureToggleName,
